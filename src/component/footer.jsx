  ...
  return (
    <div className="h-3">
        <div className='grid grid-cols-4 mt-40'>
            <div class="mx-14">
                <p className='flex gap-2 text-black font-extrabold text-lg'>Travel<p className='text-blue-600 font-extrabold text-lg'>TA</p></p>
                <p className='my-12'>With travala you can experience new travel and the best tourist destinations that we have to offer</p>
                <p className='text-[15px] text-gray-500 my-36'>Copyright © Travala 2021</p>
            </div>
            <div class="flex-col items-center flex mt-12">
            ...
            <div class="flex-col items-center flex mt-12">
                ...
                <p className='text-[15px] text-gray-500 my-24'>Terms & Conditions</p>
            </div>
            <div class="flex-col items-center flex mt-12">
                ...
                <div className='mt-6 flex gap-4'>
                    <div className='flex flex-col justify-center items-center gap-5'>
                        <svg width="10" height="20" viewBox="0 0 10 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.14971 3.29509H9.96139V0.139742C9.64884 0.0967442 8.5739 0 7.32201 0C4.70992 0 2.92057 1.643 2.92057 4.66274V7.44186H0.0380859V10.9693H2.92057V19.845H6.45462V10.9701H9.22052L9.65958 7.44269H6.4538V5.01251C6.45462 3.99297 6.72915 3.29509 8.14971 3.29509Z" fill="#0C111F"/>
                        </svg>
                ...
                <p className='text-[15px] text-gray-500 my-24'>Privacy Policy</p>
            </div>
        </div>
    </div>
  )
